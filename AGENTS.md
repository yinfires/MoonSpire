...
- Card pile/deck previews should reserve enough top and bottom space for enlarged cards. Unless an enlarged card would exceed the whole pile/deck vertical space, keep the enlarged card and its keyword tips anchored to the card's original position instead of pulling them toward screen center.
