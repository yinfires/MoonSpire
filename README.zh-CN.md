...
Moon Spire 为 Minecraft 添加了一套牌组构筑式卡牌战斗玩法。玩家可以挑战生物，击败怪物获取卡牌，消耗费用打出卡牌，管理抽牌堆、弃牌堆和被消耗的牌，并通过制卡台把装备转化为可使用的卡牌。模组还包含状态效果、怪物意图、战斗动画反馈，以及用于编辑卡牌、卡面、怪物卡组和战斗 UI 布局的开发者工具。
