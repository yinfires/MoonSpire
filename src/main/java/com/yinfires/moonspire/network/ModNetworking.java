...
public final class ModNetworking {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(SelectCardRewardPayload.TYPE, SelectCardRewardPayload.STREAM_CODEC, SelectCardRewardPayload::handle);
        ...
        registrar.playToClient(OpenCardRewardScreenPayload.TYPE, OpenCardRewardScreenPayload.STREAM_CODEC, OpenCardRewardScreenPayload::handle);
