...
public enum CardEffectKind {
    ...
    GAZE(CardTarget.SINGLE_ENEMY),
    GLOWING(CardTarget.SINGLE_ENEMY),
    GUARD(CardTarget.SELF),
    UNDYING(CardTarget.SELF),
    EVOKER_FANG_LINE(CardTarget.SINGLE_ENEMY),
    EVOKER_FANG_CIRCLE(CardTarget.ALL_ENEMIES),
    SUMMON(CardTarget.SELF),
    SUMMON_VEX(CardTarget.SELF),
    SUMMON_SILVERFISH(CardTarget.SELF),
    STRENGTH(CardTarget.SELF),
    LOSE_STRENGTH(CardTarget.SINGLE_ENEMY),
    REGENERATION(CardTarget.SELF),
    HASTE(CardTarget.SELF),
    PHASE(CardTarget.SELF),
